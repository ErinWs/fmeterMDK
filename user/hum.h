...
typedef union hum_trigger_req_t
{
    uint8_t All;
    struct
    {
        // uint8_t normal_mode_on_s_key          :1;
        // uint8_t normal_mode_on_m_key          :1;
        // uint8_t normal_mode_on_j_key          :1;
        uint8_t normal_mode_on_long_s_key     :1;
...
typedef struct _HUM_COMPONENTS
{
    ...
    /*******************end lcd seg define **************************/
    uint8_t device_driver_ram[70];
    uint8_t last_display_buff[70];
