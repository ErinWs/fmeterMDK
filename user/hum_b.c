...
static uint8_t (*const hum_sw_i2c_write)(uint16_t addr,  void const *data, uint16_t n,int8_t ack_en)=sw_i2c_write;
static const uint8_t sw_i2c_addr =0x3e;
...
#define MD_72_PIN_LCD_SEG MD_IC2_SEG(0)
#define MD_71_PIN_LCD_SEG MD_IC2_SEG(1)
#define MD_70_PIN_LCD_SEG MD_IC2_SEG(2)
#define MD_69_PIN_LCD_SEG MD_IC2_SEG(3)
#define MD_68_PIN_LCD_SEG MD_IC2_SEG(4)
#define MD_67_PIN_LCD_SEG MD_IC2_SEG(5)
#define MD_66_PIN_LCD_SEG MD_IC2_SEG(6)
#define MD_65_PIN_LCD_SEG MD_IC2_SEG(7)
#define MD_64_PIN_LCD_SEG MD_IC2_SEG(8)
#define MD_63_PIN_LCD_SEG MD_IC2_SEG(9)
#define MD_62_PIN_LCD_SEG MD_IC2_SEG(10)
#define MD_61_PIN_LCD_SEG MD_IC2_SEG(11)
#define MD_60_PIN_LCD_SEG MD_IC2_SEG(12)
#define MD_59_PIN_LCD_SEG MD_IC2_SEG(13)
#define MD_58_PIN_LCD_SEG MD_IC2_SEG(14)
#define MD_57_PIN_LCD_SEG MD_IC2_SEG(15)
#define MD_56_PIN_LCD_SEG MD_IC2_SEG(16)
#define MD_55_PIN_LCD_SEG MD_IC2_SEG(17)
#define MD_54_PIN_LCD_SEG MD_IC2_SEG(18)
#define MD_53_PIN_LCD_SEG MD_IC2_SEG(19)
#define MD_52_PIN_LCD_SEG MD_IC2_SEG(20)
#define MD_51_PIN_LCD_SEG MD_IC2_SEG(21)
#define MD_50_PIN_LCD_SEG MD_IC2_SEG(22)
#define MD_49_PIN_LCD_SEG MD_IC2_SEG(23)
#define MD_48_PIN_LCD_SEG MD_IC2_SEG(24)
#define MD_47_PIN_LCD_SEG MD_IC2_SEG(25)
#define MD_46_PIN_LCD_SEG MD_IC2_SEG(26)
#define MD_45_PIN_LCD_SEG MD_IC2_SEG(27)
#define MD_44_PIN_LCD_SEG MD_IC2_SEG(28)
#define MD_43_PIN_LCD_SEG MD_IC2_SEG(29)
#define MD_42_PIN_LCD_SEG MD_IC2_SEG(30)
#define MD_41_PIN_LCD_SEG MD_IC2_SEG(31)

#define MD_SEG(N)       (hum_comps.device_driver_ram[N])
#define MD_IC2_SEG(N)   (hum_comps.device_driver_ram[N + 36])

#define MD_DIS_S1_TOTAL_USAGE_EN     MD_05_PIN_LCD_SEG |= 0x01
#define MD_DIS_S2_TOTAL_USAGE        MD_05_PIN_LCD_SEG |= 0x02
#define MD_DIS_S3_DAY_USAGE          MD_05_PIN_LCD_SEG |= 0x04
#define MD_DIS_S4_WORK_CONDITION     MD_41_PIN_LCD_SEG |= 0x08
#define MD_DIS_S5_COM                MD_07_PIN_LCD_SEG |= 0x01
#define MD_DIS_S6_4G                 MD_09_PIN_LCD_SEG |= 0x01
#define MD_DIS_S8_BAT                MD_30_PIN_LCD_SEG |= 0x08
#define MD_DIS_S9_BAT                MD_30_PIN_LCD_SEG |= 0x04
#define MD_DIS_S10_BAT               MD_30_PIN_LCD_SEG |= 0x02
#define MD_DIS_S11_BAT               MD_30_PIN_LCD_SEG |= 0x01
#define MD_DIS_S12_BAT               MD_31_PIN_LCD_SEG |= 0x01
#define MD_DIS_S13_M3                MD_31_PIN_LCD_SEG |= 0x02
#define MD_DIS_S15_EXT_PWR           MD_31_PIN_LCD_SEG |= 0x08
#define MD_DIS_S16_TEMP              MD_40_PIN_LCD_SEG |= 0x01
#define MD_DIS_S17_TEMP_EN           MD_40_PIN_LCD_SEG |= 0x02
#define MD_DIS_S20_N                 MD_25_PIN_LCD_SEG |= 0x01
#define MD_DIS_S21_CELSIUS           MD_39_PIN_LCD_SEG |= 0x01

#define MD_DIS_K_STD_CONDITION       MD_41_PIN_LCD_SEG |= 0x04

#define MD_DIS_T1_CSQ                MD_26_PIN_LCD_SEG |= 0x01
#define MD_DIS_T2_CSQ                MD_26_PIN_LCD_SEG |= 0x02
#define MD_DIS_T3_CSQ                MD_26_PIN_LCD_SEG |= 0x04
#define MD_DIS_T4_CSQ                MD_26_PIN_LCD_SEG |= 0x08
#define MD_DIS_T10_N                 MD_27_PIN_LCD_SEG |= 0x01
#define MD_DIS_T11_B                 MD_27_PIN_LCD_SEG |= 0x02

#define MD_DIS_Z1_STD_CONDITION_EN   MD_41_PIN_LCD_SEG |= 0x01
#define MD_DIS_Z2_STD_CONDITION      MD_41_PIN_LCD_SEG |= 0x02
#define MD_DIS_Z3_M3_H               MD_52_PIN_LCD_SEG |= 0x04
#define MD_DIS_Z5_N                  MD_51_PIN_LCD_SEG |= 0x01
#define MD_DIS_Z6_WORK_CONDITION_EN  MD_52_PIN_LCD_SEG |= 0x01
#define MD_DIS_Z7_WORK_CONDITION     MD_52_PIN_LCD_SEG |= 0x02
#define MD_DIS_Z8_M_3_H              MD_62_PIN_LCD_SEG |= 0x01
#define MD_DIS_Z9_PRESS_EN           MD_63_PIN_LCD_SEG |= 0x01
#define MD_DIS_Z10_PRESS             MD_63_PIN_LCD_SEG |= 0x02
#define MD_DIS_Z13_KPA               MD_72_PIN_LCD_SEG |= 0x01
#define MD_DIS_Z14_MPA               MD_72_PIN_LCD_SEG |= 0x02

#define MD_DIS_3H_DIG0_7_DOT         MD_05_PIN_LCD_SEG |= 0x08
#define MD_DIS_4H_DIG0_6_DOT         MD_13_PIN_LCD_SEG |= 0x01
#define MD_DIS_5H_DIG0_5_DOT         MD_15_PIN_LCD_SEG |= 0x01
#define MD_DIS_6H_DIG0_4_DOT         MD_17_PIN_LCD_SEG |= 0x01
#define MD_DIS_7H_DIG0_3_DOT         MD_19_PIN_LCD_SEG |= 0x01
#define MD_DIS_8H_DIG0_2_DOT         MD_21_PIN_LCD_SEG |= 0x01
#define MD_DIS_9H_DIG0_1_DOT         MD_23_PIN_LCD_SEG |= 0x01

#define MD_DIS_15H_DIG1_4_DOT        MD_43_PIN_LCD_SEG |= 0x01
#define MD_DIS_16H_DIG1_3_DOT        MD_45_PIN_LCD_SEG |= 0x01
#define MD_DIS_17H_DIG1_2_DOT        MD_47_PIN_LCD_SEG |= 0x01
#define MD_DIS_18H_DIG1_1_DOT        MD_49_PIN_LCD_SEG |= 0x01

#define MD_DIS_11H_DIG2_3_DOT        MD_33_PIN_LCD_SEG |= 0x01
#define MD_DIS_12H_DIG2_2_DOT        MD_35_PIN_LCD_SEG |= 0x01
#define MD_DIS_13H_DIG2_1_DOT        MD_37_PIN_LCD_SEG |= 0x01

#define MD_DIS_20H_DIG3_4_DOT        MD_54_PIN_LCD_SEG |= 0x01
#define MD_DIS_21H_DIG3_3_DOT        MD_56_PIN_LCD_SEG |= 0x01
#define MD_DIS_22H_DIG3_2_DOT        MD_58_PIN_LCD_SEG |= 0x01
#define MD_DIS_23H_DIG3_1_DOT        MD_60_PIN_LCD_SEG |= 0x01

#define MD_DIS_25H_DIG4_3_DOT        MD_65_PIN_LCD_SEG |= 0x01
#define MD_DIS_26H_DIG4_2_DOT        MD_67_PIN_LCD_SEG |= 0x01
#define MD_DIS_27H_DIG4_1_DOT        MD_69_PIN_LCD_SEG |= 0x01



#define MD_HIDE_S1_TOTAL_USAGE_EN     MD_05_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_S2_TOTAL_USAGE        MD_05_PIN_LCD_SEG &= ~0x02
#define MD_HIDE_S3_DAY_USAGE          MD_05_PIN_LCD_SEG &= ~0x04
#define MD_HIDE_S4_WORK_CONDITION     MD_41_PIN_LCD_SEG &= ~0x08
#define MD_HIDE_S5_COM                MD_07_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_S6_4G                 MD_09_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_S8_BAT                MD_30_PIN_LCD_SEG &= ~0x08
#define MD_HIDE_S9_BAT                MD_30_PIN_LCD_SEG &= ~0x04
#define MD_HIDE_S10_BAT               MD_30_PIN_LCD_SEG &= ~0x02
#define MD_HIDE_S11_BAT               MD_30_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_S12_BAT               MD_31_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_S13_M3                MD_31_PIN_LCD_SEG &= ~0x02
#define MD_HIDE_S15_EXT_PWR           MD_31_PIN_LCD_SEG &= ~0x08
#define MD_HIDE_S16_TEMP              MD_40_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_S17_TEMP_EN           MD_40_PIN_LCD_SEG &= ~0x02
#define MD_HIDE_S20_N                 MD_25_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_S21_CELSIUS           MD_39_PIN_LCD_SEG &= ~0x01

#define MD_HIDE_K_STD_CONDITION       MD_41_PIN_LCD_SEG &= ~0x04

#define MD_HIDE_T1_CSQ                MD_26_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_T2_CSQ                MD_26_PIN_LCD_SEG &= ~0x02
#define MD_HIDE_T3_CSQ                MD_26_PIN_LCD_SEG &= ~0x04
#define MD_HIDE_T4_CSQ                MD_26_PIN_LCD_SEG &= ~0x08
#define MD_HIDE_T10_N                 MD_27_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_T11_B                 MD_27_PIN_LCD_SEG &= ~0x02

#define MD_HIDE_Z1_STD_CONDITION_EN   MD_41_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_Z2_STD_CONDITION      MD_41_PIN_LCD_SEG &= ~0x02
#define MD_HIDE_Z3_M3_H               MD_52_PIN_LCD_SEG &= ~0x04
#define MD_HIDE_Z5_N                  MD_51_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_Z6_WORK_CONDITION_EN  MD_52_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_Z7_WORK_CONDITION     MD_52_PIN_LCD_SEG &= ~0x02
#define MD_HIDE_Z8_M_3_H              MD_62_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_Z9_PRESS_EN           MD_63_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_Z10_PRESS             MD_63_PIN_LCD_SEG &= ~0x02
#define MD_HIDE_Z13_KPA               MD_72_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_Z14_MPA               MD_72_PIN_LCD_SEG &= ~0x02

#define MD_HIDE_3H_DIG0_7_DOT         MD_05_PIN_LCD_SEG &= ~0x08
#define MD_HIDE_4H_DIG0_6_DOT         MD_13_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_5H_DIG0_5_DOT         MD_15_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_6H_DIG0_4_DOT         MD_17_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_7H_DIG0_3_DOT         MD_19_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_8H_DIG0_2_DOT         MD_21_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_9H_DIG0_1_DOT         MD_23_PIN_LCD_SEG &= ~0x01

#define MD_HIDE_15H_DIG1_4_DOT        MD_43_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_16H_DIG1_3_DOT        MD_45_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_17H_DIG1_2_DOT        MD_47_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_18H_DIG1_1_DOT        MD_49_PIN_LCD_SEG &= ~0x01

#define MD_HIDE_11H_DIG2_3_DOT        MD_33_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_12H_DIG2_2_DOT        MD_35_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_13H_DIG2_1_DOT        MD_37_PIN_LCD_SEG &= ~0x01

#define MD_HIDE_20H_DIG3_4_DOT        MD_54_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_21H_DIG3_3_DOT        MD_56_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_22H_DIG3_2_DOT        MD_58_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_23H_DIG3_1_DOT        MD_60_PIN_LCD_SEG &= ~0x01

#define MD_HIDE_25H_DIG4_3_DOT        MD_65_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_26H_DIG4_2_DOT        MD_67_PIN_LCD_SEG &= ~0x01
#define MD_HIDE_27H_DIG4_1_DOT        MD_69_PIN_LCD_SEG &= ~0x01

static void MD_DISPLAY_WRITE_D0_0(uint8_t a)
{
    MD_25_PIN_LCD_SEG &= 1;
    MD_25_PIN_LCD_SEG |= hum_comps.SEG_TAB[a] >> 4;
    MD_24_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
}

static void MD_DISPLAY_WRITE_D0_1(uint8_t a)
{
    MD_23_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_22_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot0_pos == 1)
    ((hum_comps.cursor_0 == -1) && (hum_comps.dis_oper_mark._bit.cur0)) ? ((hum_comps.dis_oper_mark._bit.dis0) ? (MD_23_PIN_LCD_SEG |= 0x01) : (MD_23_PIN_LCD_SEG &= ~0x01)) : (MD_23_PIN_LCD_SEG |= 0x01);
}

static void MD_DISPLAY_WRITE_D0_2(uint8_t a)
{
    MD_21_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_20_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot0_pos == 2)
    ((hum_comps.cursor_0 == -1) && (hum_comps.dis_oper_mark._bit.cur0)) ? ((hum_comps.dis_oper_mark._bit.dis0) ? (MD_21_PIN_LCD_SEG |= 0x01) : (MD_21_PIN_LCD_SEG &= ~0x01)) : (MD_21_PIN_LCD_SEG |= 0x01);
}
...
static void MD_DISPLAY_WRITE_D0_3(uint8_t a)
{
    ...
    ((hum_comps.cursor_0 == -1) && (hum_comps.dis_oper_mark._bit.cur0)) ? ((hum_comps.dis_oper_mark._bit.dis0) ? (MD_19_PIN_LCD_SEG |= 0x01) : (MD_19_PIN_LCD_SEG &= ~0x01)) : (MD_19_PIN_LCD_SEG |= 0x01);
}

static void MD_DISPLAY_WRITE_D0_4(uint8_t a)
{
    MD_17_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_16_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot0_pos == 4)
    ((hum_comps.cursor_0 == -1) && (hum_comps.dis_oper_mark._bit.cur0)) ? ((hum_comps.dis_oper_mark._bit.dis0) ? (MD_17_PIN_LCD_SEG |= 0x01) : (MD_17_PIN_LCD_SEG &= ~0x01)) : (MD_17_PIN_LCD_SEG |= 0x01);
}

static void MD_DISPLAY_WRITE_D0_5(uint8_t a)
{
    MD_15_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_14_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot0_pos == 5)
    ((hum_comps.cursor_0 == -1) && (hum_comps.dis_oper_mark._bit.cur0)) ? ((hum_comps.dis_oper_mark._bit.dis0) ? (MD_15_PIN_LCD_SEG |= 0x01) : (MD_15_PIN_LCD_SEG &= ~0x01)) : (MD_15_PIN_LCD_SEG |= 0x01);
}

static void MD_DISPLAY_WRITE_D0_6(uint8_t a)
{
    MD_13_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_12_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot0_pos == 6)
    ((hum_comps.cursor_0 == -1) && (hum_comps.dis_oper_mark._bit.cur0)) ? ((hum_comps.dis_oper_mark._bit.dis0) ? (MD_13_PIN_LCD_SEG |= 0x01) : (MD_13_PIN_LCD_SEG &= ~0x01)) : (MD_13_PIN_LCD_SEG |= 0x01);
}
...
static void MD_DISPLAY_WRITE_D0_7(uint8_t a)
{
    ...
    MD_10_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    MD_HIDE_3H_DIG0_7_DOT;
    if (hum_comps.dot0_pos == 7)
    ((hum_comps.cursor_0 == -1) && (hum_comps.dis_oper_mark._bit.cur0)) ? ((hum_comps.dis_oper_mark._bit.dis0) ? (MD_DIS_3H_DIG0_7_DOT) : (MD_HIDE_3H_DIG0_7_DOT)) : (MD_DIS_3H_DIG0_7_DOT);
}
static void MD_DISPLAY_WRITE_D0_8(uint8_t a)
{
    MD_09_PIN_LCD_SEG &= 1;
    MD_09_PIN_LCD_SEG |= hum_comps.SEG_TAB[a] >> 4;
    MD_08_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
}
static void MD_DISPLAY_WRITE_D0_9(uint8_t a)
{
    MD_07_PIN_LCD_SEG &= 1;
    MD_07_PIN_LCD_SEG |= hum_comps.SEG_TAB[a] >> 4;
    MD_06_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
}
...
static void MD_DISPLAY_WRITE_D1_0(uint8_t a)
{
    ...
    MD_50_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
}

static void MD_DISPLAY_WRITE_D1_1(uint8_t a)
{
    MD_49_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_48_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
...
static void MD_DISPLAY_WRITE_D1_2(uint8_t a)
{
    ...
    MD_46_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
...
{
    MD_45_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_44_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot1_pos == 3)
    ((hum_comps.cursor_1 == -1) && (hum_comps.dis_oper_mark._bit.cur1)) ? ((hum_comps.dis_oper_mark._bit.dis1) ? (MD_45_PIN_LCD_SEG |= 0x01) : (MD_45_PIN_LCD_SEG &= ~0x01)) : (MD_45_PIN_LCD_SEG |= 0x01);
}

static void MD_DISPLAY_WRITE_D1_4(uint8_t a)
{
    MD_43_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_42_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot1_pos == 4)
    ((hum_comps.cursor_1 == -1) && (hum_comps.dis_oper_mark._bit.cur1)) ? ((hum_comps.dis_oper_mark._bit.dis1) ? (MD_43_PIN_LCD_SEG |= 0x01) : (MD_43_PIN_LCD_SEG &= ~0x01)) : (MD_43_PIN_LCD_SEG |= 0x01);
...
{
    MD_39_PIN_LCD_SEG &= 1;
    MD_39_PIN_LCD_SEG |= hum_comps.SEG_TAB[a] >> 4;
    MD_38_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
}

static void MD_DISPLAY_WRITE_D2_1(uint8_t a)
{
    MD_37_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_36_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot2_pos == 1)
    ((hum_comps.cursor_2 == -1) && (hum_comps.dis_oper_mark._bit.cur2)) ? ((hum_comps.dis_oper_mark._bit.dis2) ? (MD_37_PIN_LCD_SEG |= 0x01) : (MD_37_PIN_LCD_SEG &= ~0x01)) : (MD_37_PIN_LCD_SEG |= 0x01);
}
static void MD_DISPLAY_WRITE_D2_2(uint8_t a)
{
    MD_35_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_34_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot2_pos == 2)
    ((hum_comps.cursor_2 == -1) && (hum_comps.dis_oper_mark._bit.cur2)) ? ((hum_comps.dis_oper_mark._bit.dis2) ? (MD_35_PIN_LCD_SEG |= 0x01) : (MD_35_PIN_LCD_SEG &= ~0x01)) : (MD_35_PIN_LCD_SEG |= 0x01);
}
static void MD_DISPLAY_WRITE_D2_3(uint8_t a)
{
    MD_33_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_32_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot2_pos == 3)
    ((hum_comps.cursor_2 == -1) && (hum_comps.dis_oper_mark._bit.cur2)) ? ((hum_comps.dis_oper_mark._bit.dis2) ? (MD_33_PIN_LCD_SEG |= 0x01) : (MD_33_PIN_LCD_SEG &= ~0x01)) : (MD_33_PIN_LCD_SEG |= 0x01);
}

static void MD_DISPLAY_WRITE_D3_0(uint8_t a)
{
    MD_62_PIN_LCD_SEG &= 1;
    MD_62_PIN_LCD_SEG |= hum_comps.SEG_TAB[a] >> 4;
    MD_61_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
}
static void MD_DISPLAY_WRITE_D3_1(uint8_t a)
{
    MD_60_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_59_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot3_pos == 1)
    ((hum_comps.cursor_3 == -1) && (hum_comps.dis_oper_mark._bit.cur3)) ? ((hum_comps.dis_oper_mark._bit.dis3) ? (MD_60_PIN_LCD_SEG |= 0x01) : (MD_60_PIN_LCD_SEG &= ~0x01)) : (MD_60_PIN_LCD_SEG |= 0x01);

}

static void MD_DISPLAY_WRITE_D3_2(uint8_t a)
{
    MD_58_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_57_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot3_pos == 2)
    ((hum_comps.cursor_3 == -1) && (hum_comps.dis_oper_mark._bit.cur3)) ? ((hum_comps.dis_oper_mark._bit.dis3) ? (MD_58_PIN_LCD_SEG |= 0x01) : (MD_58_PIN_LCD_SEG &= ~0x01)) : (MD_58_PIN_LCD_SEG |= 0x01);
}

static void MD_DISPLAY_WRITE_D3_3(uint8_t a)
{
    MD_56_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_55_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot3_pos == 3)
    ((hum_comps.cursor_3 == -1) && (hum_comps.dis_oper_mark._bit.cur3)) ? ((hum_comps.dis_oper_mark._bit.dis3) ? (MD_56_PIN_LCD_SEG |= 0x01) : (MD_56_PIN_LCD_SEG &= ~0x01)) : (MD_56_PIN_LCD_SEG |= 0x01);

}
static void MD_DISPLAY_WRITE_D3_4(uint8_t a)
{
    MD_54_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_53_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot3_pos == 4)
    ((hum_comps.cursor_3 == -1) && (hum_comps.dis_oper_mark._bit.cur3)) ? ((hum_comps.dis_oper_mark._bit.dis3) ? (MD_54_PIN_LCD_SEG |= 0x01) : (MD_54_PIN_LCD_SEG &= ~0x01)) : (MD_54_PIN_LCD_SEG |= 0x01);
...
{
    MD_71_PIN_LCD_SEG &= 1;
    MD_71_PIN_LCD_SEG |= hum_comps.SEG_TAB[a] >> 4;
    MD_70_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
}

static void MD_DISPLAY_WRITE_D4_1(uint8_t a)
{
    MD_69_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_68_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot4_pos == 1)
    ((hum_comps.cursor_4 == -1) && (hum_comps.dis_oper_mark._bit.cur4)) ? ((hum_comps.dis_oper_mark._bit.dis4) ? (MD_69_PIN_LCD_SEG |= 0x01) : (MD_69_PIN_LCD_SEG &= ~0x01)) : (MD_69_PIN_LCD_SEG |= 0x01);
}

static void MD_DISPLAY_WRITE_D4_2(uint8_t a)
{
    MD_67_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_66_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot4_pos == 2)
    ((hum_comps.cursor_4 == -1) && (hum_comps.dis_oper_mark._bit.cur4)) ? ((hum_comps.dis_oper_mark._bit.dis4) ? (MD_67_PIN_LCD_SEG |= 0x01) : (MD_67_PIN_LCD_SEG &= ~0x01)) : (MD_67_PIN_LCD_SEG |= 0x01);
}

static void MD_DISPLAY_WRITE_D4_3(uint8_t a)
{
    MD_65_PIN_LCD_SEG = hum_comps.SEG_TAB[a] >> 4;
    MD_64_PIN_LCD_SEG = hum_comps.SEG_TAB[a] & 0x0f;
    if (hum_comps.dot4_pos == 3)
    ((hum_comps.cursor_4 == -1) && (hum_comps.dis_oper_mark._bit.cur4)) ? ((hum_comps.dis_oper_mark._bit.dis4) ? (MD_65_PIN_LCD_SEG |= 0x01) : (MD_65_PIN_LCD_SEG &= ~0x01)) : (MD_65_PIN_LCD_SEG |= 0x01);
}
static void display_line0_data(void) // display 1th line data
{
#define MD_DIS_ALL_0_LINE_DATA (MD_DISPLAY_WRITE_D0_9(hum_comps.dig0_9),MD_DISPLAY_WRITE_D0_8(hum_comps.dig0_8),MD_DISPLAY_WRITE_D0_7(hum_comps.dig0_7), MD_DISPLAY_WRITE_D0_6(hum_comps.dig0_6), MD_DISPLAY_WRITE_D0_5(hum_comps.dig0_5), MD_DISPLAY_WRITE_D0_4(hum_comps.dig0_4), MD_DISPLAY_WRITE_D0_3(hum_comps.dig0_3), MD_DISPLAY_WRITE_D0_2(hum_comps.dig0_2), MD_DISPLAY_WRITE_D0_1(hum_comps.dig0_1), MD_DISPLAY_WRITE_D0_0(hum_comps.dig0_0))
#define MD_HID_ALL_0_LINE_DATA (MD_DISPLAY_WRITE_D0_9(MD_HIDE_DISP),MD_DISPLAY_WRITE_D0_8(MD_HIDE_DISP),MD_DISPLAY_WRITE_D0_7(MD_HIDE_DISP), MD_DISPLAY_WRITE_D0_6(MD_HIDE_DISP), MD_DISPLAY_WRITE_D0_5(MD_HIDE_DISP), MD_DISPLAY_WRITE_D0_4(MD_HIDE_DISP), MD_DISPLAY_WRITE_D0_3(MD_HIDE_DISP), MD_DISPLAY_WRITE_D0_2(MD_HIDE_DISP), MD_DISPLAY_WRITE_D0_1(MD_HIDE_DISP), MD_DISPLAY_WRITE_D0_0(MD_HIDE_DISP))
    if (hum_comps.cursor_0 > -1)
    {
        ((hum_comps.cursor_0 == 9) && (hum_comps.dis_oper_mark._bit.cur0)) ? ((hum_comps.dis_oper_mark._bit.dis0) ? MD_DISPLAY_WRITE_D0_9(hum_comps.dig0_9) : MD_DISPLAY_WRITE_D0_9(MD_HIDE_DISP)) : MD_DISPLAY_WRITE_D0_9(hum_comps.dig0_9);
        ((hum_comps.cursor_0 == 8) && (hum_comps.dis_oper_mark._bit.cur0)) ? ((hum_comps.dis_oper_mark._bit.dis0) ? MD_DISPLAY_WRITE_D0_8(hum_comps.dig0_8) : MD_DISPLAY_WRITE_D0_8(MD_HIDE_DISP)) : MD_DISPLAY_WRITE_D0_8(hum_comps.dig0_8);
...
{
#define MD_DIS_ALL_3_LINE_DATA (MD_DISPLAY_WRITE_D3_4(hum_comps.dig3_4),MD_DISPLAY_WRITE_D3_3(hum_comps.dig3_3), MD_DISPLAY_WRITE_D3_2(hum_comps.dig3_2), MD_DISPLAY_WRITE_D3_1(hum_comps.dig3_1), MD_DISPLAY_WRITE_D3_0(hum_comps.dig3_0))
#define MD_HID_ALL_3_LINE_DATA (MD_DISPLAY_WRITE_D3_4(MD_HIDE_DISP), MD_DISPLAY_WRITE_D3_3(MD_HIDE_DISP), MD_DISPLAY_WRITE_D3_2(MD_HIDE_DISP), MD_DISPLAY_WRITE_D3_1(MD_HIDE_DISP), MD_DISPLAY_WRITE_D3_0(MD_HIDE_DISP))
...
{
    MD_DIS_S1_TOTAL_USAGE_EN;
    MD_DIS_S2_TOTAL_USAGE;
    MD_DIS_S3_DAY_USAGE;
    MD_DIS_S4_WORK_CONDITION;
    MD_DIS_S6_4G;
    MD_DIS_S8_BAT;
    MD_DIS_S9_BAT;
    MD_DIS_S10_BAT;
    ...
    MD_DIS_T10_N;
    MD_DIS_T11_B;
    MD_DIS_Z1_STD_CONDITION_EN;
    MD_DIS_Z2_STD_CONDITION;
    MD_DIS_Z3_M3_H;
    MD_DIS_Z5_N;
    MD_DIS_Z6_WORK_CONDITION_EN;
    MD_DIS_Z7_WORK_CONDITION;
    MD_DIS_Z8_M_3_H;
    MD_DIS_Z9_PRESS_EN;
    MD_DIS_Z10_PRESS;
    MD_DIS_Z13_KPA;
    MD_DIS_3H_DIG0_7_DOT;
    MD_DIS_4H_DIG0_6_DOT;
    MD_DIS_5H_DIG0_5_DOT;
    MD_DIS_6H_DIG0_4_DOT;
    MD_DIS_7H_DIG0_3_DOT;
    MD_DIS_8H_DIG0_2_DOT;
    MD_DIS_9H_DIG0_1_DOT;
    MD_DIS_15H_DIG1_4_DOT;
    MD_DIS_16H_DIG1_3_DOT;
    MD_DIS_17H_DIG1_2_DOT;
    MD_DIS_18H_DIG1_1_DOT;
    MD_DIS_11H_DIG2_3_DOT;
    MD_DIS_12H_DIG2_2_DOT;
    MD_DIS_13H_DIG2_1_DOT;
    MD_DIS_20H_DIG3_4_DOT;
    MD_DIS_21H_DIG3_3_DOT;
    MD_DIS_22H_DIG3_2_DOT;
    MD_DIS_23H_DIG3_1_DOT;
    MD_DIS_25H_DIG4_3_DOT;
    MD_DIS_26H_DIG4_2_DOT;
    MD_DIS_27H_DIG4_1_DOT;
}

static void hide_all_symbol(void)
{
    MD_HIDE_S1_TOTAL_USAGE_EN;
    MD_HIDE_S2_TOTAL_USAGE;
    MD_HIDE_S3_DAY_USAGE;
    MD_HIDE_S4_WORK_CONDITION;
    MD_HIDE_S6_4G;
    MD_HIDE_S8_BAT;
    MD_HIDE_S9_BAT;
    MD_HIDE_S10_BAT;
    ...
    MD_HIDE_T10_N;
    MD_HIDE_T11_B;
    MD_HIDE_Z1_STD_CONDITION_EN;
    MD_HIDE_Z2_STD_CONDITION;
    MD_HIDE_Z3_M3_H;
    MD_HIDE_Z5_N;
    MD_HIDE_Z6_WORK_CONDITION_EN;
    MD_HIDE_Z7_WORK_CONDITION;
    MD_HIDE_Z8_M_3_H;
    MD_HIDE_Z9_PRESS_EN;
    MD_HIDE_Z10_PRESS;
    MD_HIDE_Z13_KPA;
    MD_HIDE_3H_DIG0_7_DOT;
    MD_HIDE_4H_DIG0_6_DOT;
    MD_HIDE_5H_DIG0_5_DOT;
    MD_HIDE_6H_DIG0_4_DOT;
    MD_HIDE_7H_DIG0_3_DOT;
    MD_HIDE_8H_DIG0_2_DOT;
    MD_HIDE_9H_DIG0_1_DOT;
    MD_HIDE_15H_DIG1_4_DOT;
    MD_HIDE_16H_DIG1_3_DOT;
    MD_HIDE_17H_DIG1_2_DOT;
    MD_HIDE_18H_DIG1_1_DOT;
    MD_HIDE_11H_DIG2_3_DOT;
    MD_HIDE_12H_DIG2_2_DOT;
    MD_HIDE_13H_DIG2_1_DOT;
    MD_HIDE_20H_DIG3_4_DOT;
    MD_HIDE_21H_DIG3_3_DOT;
    MD_HIDE_22H_DIG3_2_DOT;
    MD_HIDE_23H_DIG3_1_DOT;
    MD_HIDE_25H_DIG4_3_DOT;
    MD_HIDE_26H_DIG4_2_DOT;
    MD_HIDE_27H_DIG4_1_DOT;
}
...
static void lcd_test(hum_comps_t *const this)
{
    ...
    if (this->count == 8 * 6)
    {
        ...
        MD_DISPLAY_WRITE_D0_9(this->dig0_9);
    }
    if (this->count == 9 * 6)
    {
        dis_all_symbol();
    ...
    if (device_comps.press_cal_param.is_calibrated)
    {
        if (device_comps.press_cal_param.unit == 0)
        {
            if (device_comps.press_cal_param.dot == 5 && device_comps.current_press / 100 < 1000)
            {
                ...
                hum_comps.dot4_pos = device_comps.press_cal_param.dot - 4;
                MD_DIS_Z13_KPA;
            }
            else
            {
                num = device_comps.current_press / 100;
                hum_comps.dot4_pos = device_comps.press_cal_param.dot - 2;
                MD_DIS_Z14_MPA;
            }
        }
        else
...
static void display_current_flow_N(uint8_t opt)
{
    int32_t num;
    hide_line1_all_unit();
    num = device_comps.current_flowN / pwr(1);
    hum_comps.dot1_pos = device_comps.flow_cal_param.dot - 1;
    if (num > 99999 && hum_comps.dot1_pos > 0)
    {
        num /= 10;
        hum_comps.dot1_pos -= 1;
        // if (num > 99999 && hum_comps.dot1_pos > 0)
...
static void display_current_flow(uint8_t opt)
{
    int32_t num;
    hide_line3_all_unit();
    num = device_comps.current_flow / pwr(1);
    hum_comps.dot3_pos = device_comps.flow_cal_param.dot - 1;
    MD_DIS_Z7_WORK_CONDITION;
    MD_DIS_Z8_M_3_H;
    calc_seg_value(&hum_comps.dig3_0, 5, num, 1, hum_comps.dot3_pos + 1);
    hum_comps.dis_oper_mark._bit.cur3 = 0;
    display_line3_data();
}
...
static void display_current_totalN(uint8_t opt)
{
    ...
    if(num < 100)
    {
        hum_comps.dot0_pos=7;
        num=num*pwr(hum_comps.dot0_pos) +(uint32_t)(total_dec*10000) ;
     }
    else if(num < 1000)
    {
        hum_comps.dot0_pos=6;
        num=num*pwr(hum_comps.dot0_pos) +(uint32_t)(total_dec*1000) ;
    }
    else if (num < 10000)
    {
        hum_comps.dot0_pos = 5;
        num = num * pwr(hum_comps.dot0_pos) + (uint32_t)(total_dec * 100);

    }
    else if (num < 100000)
    {
        hum_comps.dot0_pos = 4;
        num = num * pwr(hum_comps.dot0_pos) + (uint32_t)(total_dec * 10);
    }
    else if (num < 1000000)
    {
        hum_comps.dot0_pos = 3;
        num = num * pwr(hum_comps.dot0_pos) + (uint32_t)(total_dec);
    }
    ...
    calc_seg_value(&hum_comps.dig0_0, 9, num, 1, hum_comps.dot0_pos + 1);
    hum_comps.dis_oper_mark._bit.cur0 = 0;
    display_line0_data();
    MD_DIS_K_STD_CONDITION;
    MD_DIS_S2_TOTAL_USAGE;
...
static void hide_line1_3_info(void)
{
...
static void display_4G_ipH_addr(void)
{
    int32_t num;
    char *ptsz;
    hide_line0_all_unit();
...
static void display_4G_ipL_addr(void)
{
    int32_t num;
    char *ptsz;
    hide_line0_all_unit();
...
static void display_4G_port(void)
{
    int32_t num;
    hide_line0_all_unit();
    hum_comps.dot0_pos = 0;
    num = device_comps.access_param.port;
    calc_seg_value(&hum_comps.dig0_0, 6, num, 0, hum_comps.dot0_pos + 1);
    hum_comps.dig0_6 = MD_HIDE_DISP;
    hum_comps.dig0_7 = MD_HIDE_DISP;
    hum_comps.dig0_8 = MD_HIDE_DISP;
...
static void display_modbus_addr(void)
{
    int32_t num;
    hide_line0_all_unit();
    hum_comps.dot0_pos = 0;
...
static void  display_soft_ver(void)
{
    hide_line0_all_unit();
    hum_comps.dot0_pos = 1;
...
static void display_device_addrH(void)
{
    hide_line0_all_unit();
    hum_comps.dot0_pos=0;
    hum_comps.dig0_0=device_comps.device_addr.addr[4]&0x0f;
    hum_comps.dig0_1=device_comps.device_addr.addr[4]>>4;
    hum_comps.dig0_2=device_comps.device_addr.addr[3]&0x0f;
    hum_comps.dig0_3=device_comps.device_addr.addr[3]>>4;
    hum_comps.dig0_4=device_comps.device_addr.addr[2]&0x0f;
    hum_comps.dig0_5=device_comps.device_addr.addr[2]>>4;
    hum_comps.dig0_6 = MD_HIDE_DISP;
    hum_comps.dig0_7 = MD_HIDE_DISP;
    hum_comps.dig0_8 = MD_HIDE_DISP;
    hum_comps.dig0_9 = MD_HIDE_DISP;
 ...
 static void display_device_addrL(void)
 {
    hide_line0_all_unit();
    hum_comps.dot0_pos=0;
    hum_comps.dig0_0=device_comps.device_addr.addr[6]&0x0f;
    hum_comps.dig0_1=device_comps.device_addr.addr[6]>>4;
    hum_comps.dig0_2=device_comps.device_addr.addr[5]&0x0f;
    hum_comps.dig0_3=device_comps.device_addr.addr[5]>>4;
    hum_comps.dig0_4=MD_HIDE_DISP;
    hum_comps.dig0_5=MD_HIDE_DISP;
    hum_comps.dig0_6 = MD_HIDE_DISP;
    hum_comps.dig0_7 = MD_HIDE_DISP;
...
static void display_lora_freq(void)
{
    int32_t num;
    hide_line0_all_unit();
    hum_comps.dot0_pos = 0;
...
static void display_lora_netId(void)
{
    int32_t num;
    hide_line0_all_unit();
    hum_comps.dot0_pos = 0;
...
static void display_lora_nodeIdH(void)
{
    int32_t num;
    hide_line0_all_unit();
    hum_comps.dot0_pos = 0;
    num = (long)((unsigned long)loraComps.cfg_info_p->nodeId >> 16);
    calc_seg_value(&hum_comps.dig0_0, 6, num, 0, hum_comps.dot0_pos + 1);
    hum_comps.dig0_6 = MD_HIDE_DISP;
    hum_comps.dig0_7 = MD_HIDE_DISP;
    hum_comps.dig0_8 = MD_HIDE_DISP;
...
static void display_lora_nodeIdL(void)
{
    int32_t num;
    hide_line0_all_unit();
    hum_comps.dot0_pos = 0;
    num = (long)((unsigned long)loraComps.cfg_info_p->nodeId & 0xFFFF);
    calc_seg_value(&hum_comps.dig0_0, 6, num, 0, hum_comps.dot0_pos + 1);
    hum_comps.dig0_6 = MD_HIDE_DISP;
    hum_comps.dig0_7 = MD_HIDE_DISP;
    hum_comps.dig0_8 = MD_HIDE_DISP;
...
static void normal_mode_no_iot_product_display(uint8_t opt)
{
    if (opt > 0)
    {
        display_opt(opt);
...
void normal_mode_4G_product_display(uint8_t opt)
{
    if (opt > 0)
    {
        display_opt(opt);
...
static void normal_mode_Lora_product_display(uint8_t opt)
{
    if (opt > 0)
    {
        display_opt(opt);
...
{
    #if(MD_PRODUCT_NAME == MD_NO_IOT)
        normal_mode_no_iot_product_display(opt);
    #elif(MD_PRODUCT_NAME == MD_4G)
        normal_mode_4G_product_display(opt);
    #else
        normal_mode_Lora_product_display(opt);
    #endif
...
static void debug_mode_display(uint8_t opt)
{
    ...
    if (hum_comps.dis_oper_mark._bit.refresh_debug_param)
    {
        ...
        case 0:
            ...
            num = get_float_disp_num(device_comps.flow_run_meter_coe, 5, &hum_comps.dot3_pos);
            calc_seg_value(&hum_comps.dig3_0, 5, num, 0, hum_comps.dot3_pos + 1);
            display_line3_data();
        ...
        case 1:
            num = sci_comps.periph.DM.measure_data.voltage;
            hum_comps.dot1_pos = 3;
            calc_seg_value(&hum_comps.dig1_0, 5, num, 1, hum_comps.dot1_pos + 1);
            display_line1_data();
            ...
            num = sci_comps.periph.DM.measure_data.current;
...
static void display_special_batt(void)
{
    ...
    {
        init_once = 0;
        if (device_comps.batt > MD_BAT_88_PER_100)     {MD_DIS_S8_BAT;MD_DIS_S9_BAT ;MD_DIS_S10_BAT ;MD_DIS_S11_BAT ;MD_DIS_S12_BAT;}
        else if (device_comps.batt > MD_BAT_85_PER_100){MD_DIS_S8_BAT;MD_HIDE_S9_BAT;MD_DIS_S10_BAT ;MD_DIS_S11_BAT ;MD_DIS_S12_BAT;}
        else if (device_comps.batt > MD_BAT_80_PER_100){MD_DIS_S8_BAT;MD_HIDE_S9_BAT;MD_HIDE_S10_BAT;MD_DIS_S11_BAT ;MD_DIS_S12_BAT;}
        else                                           {MD_DIS_S8_BAT;MD_HIDE_S9_BAT;MD_HIDE_S10_BAT;MD_HIDE_S11_BAT;MD_DIS_S12_BAT;}
    }
    else
    {
        if      (device_comps.batt > MD_BAT_88_PER_100){MD_DIS_S8_BAT;MD_DIS_S9_BAT;MD_DIS_S10_BAT;MD_DIS_S11_BAT;MD_DIS_S12_BAT;}
        ...
        {
            if (device_comps.batt < MD_BAT_88_PER_100){MD_DIS_S8_BAT;MD_HIDE_S9_BAT;MD_DIS_S10_BAT;MD_DIS_S11_BAT;MD_DIS_S12_BAT;}
        }
        else if (device_comps.batt > MD_BAT_80_PER_100)
        {
            if (device_comps.batt < MD_BAT_85_PER_100){MD_DIS_S8_BAT;MD_HIDE_S9_BAT;MD_DIS_S10_BAT;MD_DIS_S11_BAT;MD_DIS_S12_BAT;}
        }
        else if (device_comps.batt < MD_BAT_80_PER_100){ MD_DIS_S8_BAT; MD_HIDE_S9_BAT; MD_HIDE_S10_BAT; MD_HIDE_S11_BAT; MD_DIS_S12_BAT; }
     }
}
...
static void display_special_symbol(void)
{
    ...
    (!ircComps.sw._bit.runing && !modbusComps.sw._bit.runing && !loraComps.sw._bit.runing) ? (MD_HIDE_S5_COM) : (MD_DIS_S5_COM);
    (device_comps.sw._bit.is_4_20ma_Connected || device_comps.sw._bit.isExtPowerConnected) ? (MD_DIS_S15_EXT_PWR) : (MD_HIDE_S15_EXT_PWR);
    if(loraComps.dis_rssi_tmr_s>1)
    {
        if(loraComps.packageRssi<MD_ELORA_RSSI_104DBM)     { MD_DIS_T1_CSQ;MD_HIDE_T2_CSQ;MD_HIDE_T3_CSQ;MD_HIDE_T4_CSQ;}
        else if(loraComps.packageRssi<MD_ELORA_RSSI_94DBM) { MD_DIS_T1_CSQ;MD_DIS_T2_CSQ ;MD_HIDE_T3_CSQ;MD_HIDE_T4_CSQ;}
        else if(loraComps.packageRssi<MD_ELORA_RSSI_84DBM) { MD_DIS_T1_CSQ;MD_DIS_T2_CSQ ;MD_DIS_T3_CSQ ;MD_HIDE_T4_CSQ;}
        else                                               { MD_DIS_T1_CSQ;MD_DIS_T2_CSQ ;MD_DIS_T3_CSQ ;MD_DIS_T4_CSQ ;}
        if(loraComps.dis_rssi_tmr_s<=3)                    {loraComps.dis_rssi_tmr_s=0; MD_HIDE_T1_CSQ;MD_HIDE_T2_CSQ;MD_HIDE_T3_CSQ;MD_HIDE_T4_CSQ;}

    }
    if ((netComps.St._bit.running) && (netComps.disCode >= EM_DIS_SEARCH_NET))
    {
        if (netComps.net_info.Csq < 7) {MD_DIS_T1_CSQ;MD_HIDE_T2_CSQ;MD_HIDE_T3_CSQ; MD_HIDE_T4_CSQ;}
        else if (netComps.net_info.Csq < 15) {MD_DIS_T1_CSQ;MD_DIS_T2_CSQ;MD_HIDE_T3_CSQ;MD_HIDE_T4_CSQ;}
        else if (netComps.net_info.Csq < 22) {MD_DIS_T1_CSQ;MD_DIS_T2_CSQ;MD_DIS_T3_CSQ;MD_HIDE_T4_CSQ;}
        else if (netComps.net_info.Csq < 32) {MD_DIS_T1_CSQ;MD_DIS_T2_CSQ;MD_DIS_T3_CSQ;MD_DIS_T4_CSQ;}
        else{ MD_HIDE_T1_CSQ;MD_HIDE_T2_CSQ;MD_HIDE_T3_CSQ;MD_HIDE_T4_CSQ;}
    }
...
{
    const uint8_t AD_SET = 0x00;
    uint8_t data[1 + 36 / 2] = {AD_SET + 0x00};
    uint8_t data_2[1 + 32 / 2] = {AD_SET + 0x00};
    memset(this->device_driver_ram, 0, 68);
    memcpy(this->last_display_buff, this->device_driver_ram, 68);
    hum_sw_i2c_write(sw_i2c_addr,data, sizeof(data),1);
    I2C_MasterWriteData(MD_LCD_I2CX_SEL, data_2, sizeof(data_2));
}
static void App_Disp_IC_Init(void)
{
    const uint8_t DIS_CTL = 0x31;
    const uint8_t MODE_SET = 0x48;
    const uint8_t IC_SET = 0x68;
    uint8_t cmd[] = {DIS_CTL + 0x80, MODE_SET + 0x80, IC_SET + 0x80}; //
    if(hum_sw_i2c_write(sw_i2c_addr,cmd, sizeof(cmd),1)==1)
    {
        hum_sw_i2c_write(sw_i2c_addr,cmd, sizeof(cmd),1);
    }
    if (I2C_MasterWriteData(MD_LCD_I2CX_SEL, cmd, sizeof(cmd)) == Error)
    {
        I2C_MasterWriteData(MD_LCD_I2CX_SEL, cmd, sizeof(cmd));
    }
}
static void flush_display_buffer(hum_comps_t *this)
{
    if(memcmp(this->device_driver_ram, this->last_display_buff, 36) != 0)
    {
        const uint8_t AD_SET=0x00;
        uint8_t data[1+36/2] = {AD_SET + 0x00};
        int16_t i = 0;
        for (i = 0; i < 36; i+=2)
        {
            data[1 + i / 2] = this->device_driver_ram[i] << 4 | this->device_driver_ram[i + 1];
            data[1 + i / 2] = reverse_H(data[1 + i / 2]) + reverse_L(data[1 + i / 2]);
        }
        memcpy(this->last_display_buff, this->device_driver_ram, 36);
        hum_sw_i2c_write(sw_i2c_addr, data, sizeof(data),1);
    }
    if(memcmp(this->device_driver_ram+36, this->last_display_buff+36, 32) != 0)
    {
        const uint8_t AD_SET=0x00;
        uint8_t data[1+32/2] = {AD_SET + 0x00};
        int16_t i = 0;
        for (i = 0; i < 32; i += 2)
        {
            data[1 + i / 2] = this->device_driver_ram[36 + i] << 4 | this->device_driver_ram[36 + i + 1];
          //  data[1 + i / 2] = reverse_H(data[1 + i / 2]) + reverse_L(data[1 + i / 2]);
        }
        memcpy(this->last_display_buff+36, this->device_driver_ram+36, 32);
        I2C_MasterWriteData(MD_LCD_I2CX_SEL, data, sizeof(data));
    }

}
static void App_Rst_IC_Display(hum_comps_t *this)
{
    const uint8_t AD_SET = 0x00;
    int16_t i = 0;
    uint8_t data[1 + 36 / 2] = {AD_SET + 0x00};
    ...
    for (i = 0; i < 32; i += 2)
    {
        data_2[1 + i / 2] = this->device_driver_ram[36 + i] << 4 | this->device_driver_ram[36 + i + 1];
       // data_2[1 + i / 2] = reverse_H(data_2[1 + i / 2]) + reverse_L(data_2[1 + i / 2]);
    }
    memcpy(this->last_display_buff, this->device_driver_ram, 68);
    hum_sw_i2c_write(sw_i2c_addr,data, sizeof(data),1);
    I2C_MasterWriteData(MD_LCD_I2CX_SEL, data_2, sizeof(data_2));
