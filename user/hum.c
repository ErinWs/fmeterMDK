...
//     }
//}
static void hide_line1_2_4_5_info(void)
{
    hum_comps.dot1_pos = 0;
    hide_line1_all_unit();
    MD_HID_ALL_1_LINE_DATA;
...
static void display_device_addrH(void)
{
    hide_line3_all_unit();
    hum_comps.dot3_pos=0;
    hum_comps.dig3_0=device_comps.device_addr.addr[4]&0x0f;
    hum_comps.dig3_1=device_comps.device_addr.addr[4]>>4;
    hum_comps.dig3_2=device_comps.device_addr.addr[3]&0x0f;
    hum_comps.dig3_3=device_comps.device_addr.addr[3]>>4;
    hum_comps.dig3_4=device_comps.device_addr.addr[2]&0x0f;
    hum_comps.dig3_5=device_comps.device_addr.addr[2]>>4;
    display_line3_data();    // 
 }
 static void display_device_addrL(void)
 {
    hide_line3_all_unit();
    hum_comps.dot3_pos=0;
    hum_comps.dig3_0=device_comps.device_addr.addr[6]&0x0f;
    hum_comps.dig3_1=device_comps.device_addr.addr[6]>>4;
    hum_comps.dig3_2=device_comps.device_addr.addr[5]&0x0f;
    hum_comps.dig3_3=device_comps.device_addr.addr[5]>>4;
    hum_comps.dig3_4=MD_HIDE_DISP;
    hum_comps.dig3_5=MD_HIDE_DISP;
    display_line3_data();    // 
}
...
static void normal_mode_4G_product_display(uint8_t opt)
{
    if (opt > 0)
    {
        display_opt(opt);
